...
from dialogue_runtime.shared.constants import DEFAULT_SERVER_PORT
...
def main(args: Optional[list] = None) -> None:
    ...
    try:
        # 导入并注册子命令
        from dialogue_runtime.cli.init import init_command
        from dialogue_runtime.cli.train import train_command
        from dialogue_runtime.cli.run import run_command
        from dialogue_runtime.cli.shell import shell_command
        from dialogue_runtime.cli.export import export_command
        from dialogue_runtime.cli.inspect import inspect_command
