...
from dialogue_runtime.agent.message_processor import (
    MessageProcessor,
    ProcessorConfig,
    MessageResponse,
)
from dialogue_runtime.agent.actions import register_action, Action
from dialogue_runtime.agent.graph import (
...
from dialogue_runtime.core.stores import create_tracker_store, TrackerStore
from dialogue_runtime.dialogue_understanding.flow import FlowsList, FlowLoader
from dialogue_runtime.dialogue_understanding.generator import LLMCommandGenerator
from dialogue_runtime.dialogue_understanding.processor import CommandProcessor
from dialogue_runtime.policies import PolicyEnsemble, FlowPolicy, EnterpriseSearchPolicy
from dialogue_runtime.shared.yaml_loader import read_yaml_file
from dialogue_runtime.shared.config import AtguiguConfig, LLMConfig
...
class Agent:
    ...
    def load(
        ...
        from dialogue_runtime.shared.config import EndpointsConfig
        ...
        if config_path.exists():
            ...
            if config_data:
                ...
                if "retrieval" in config_data:
                    from dialogue_runtime.shared.config import RetrievalConfig
        ...
        if llm_config:
            from dialogue_runtime.dialogue_understanding.generator import (
                LLMCommandGenerator,
                LLMGeneratorConfig,
            )
        ...
        # 创建策略
        from dialogue_runtime.policies import EnterpriseSearchPolicyConfig
        ...
        if retriever_class_path:
            try:
                from dialogue_runtime.retrieval import create_retriever
        ...
        if nlg_config and nlg_config.rephrase_enabled:
            try:
                from dialogue_runtime.nlg import ResponseRephraser, RephraserConfig, TemplateNLG
                ...
                if rephrase_llm_config:
                    ...
                    # 创建LLM客户端
                    from dialogue_runtime.shared.llm import create_llm_client
