...
from dialogue_runtime.dialogue_understanding.commands.base import Command, register_command
from dialogue_runtime.shared.constants import DegradationReason
