...
from dialogue_runtime.dialogue_understanding.commands.base import (
    Command,
    get_all_command_classes,
    parse_command_from_text,
)
from dialogue_runtime.dialogue_understanding.commands.error_commands import ParseErrorCommand
