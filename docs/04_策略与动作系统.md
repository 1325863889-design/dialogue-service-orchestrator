...
if TYPE_CHECKING:
    from dialogue_runtime.core.tracker import DialogueStateTracker
    from dialogue_runtime.core.domain import Domain
    from dialogue_runtime.dialogue_understanding.flow import FlowsList, Flow, FlowStep
...
class FlowPolicy(Policy):
    ...
    async def predict(
        ...
        **kwargs: Any,
        ...
        from dialogue_runtime.dialogue_understanding.flow import StepType
...
if TYPE_CHECKING:
    from dialogue_runtime.core.tracker import DialogueStateTracker
    from dialogue_runtime.core.domain import Domain
    from dialogue_runtime.core.events import Event
...
class ActionRestart(Action):
    ...
    async def run(
        ...
        """重置对话状态。"""
        from dialogue_runtime.core.events import Restarted
...
class ActionSessionStart(Action):
    ...
    async def run(
        ...
        """初始化会话。"""
        from dialogue_runtime.core.events import SessionStarted, SlotSet
...
class ActionDefaultFallback(Action):
    ...
    async def run(
        ...
        """返回默认降级消息。"""
        from dialogue_runtime.core.events import BotUttered
...
```python
from dialogue_runtime.agent.actions import Action, register_action
...
class ActionQueryOrderDetail(Action):
    ...
    async def run(
        ...
        """查询订单详情。"""
        from dialogue_runtime.core.events import BotUttered, SlotSet
