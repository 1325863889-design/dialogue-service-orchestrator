...
```bash
# 创建环境
conda create -n dialogue_runtime python=3.10 -y

# 激活环境
conda activate dialogue_runtime
```
...
```bash
# 查看CLI帮助
python -m dialogue_runtime --help

# 输出示例：
# Usage: python -m dialogue_runtime [OPTIONS] COMMAND [ARGS]...
# 
# AtguiguAI - 教学版对话系统框架
# 
# Commands:
