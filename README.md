# Dialogue Service Orchestrator

> Repository: 1325863889-design/dialogue-service-orchestrator  
> Status: portfolio-ready source package

## Overview

A modular customer-dialogue runtime for intent handling, flow orchestration, policy selection, actions, and multi-channel service interfaces.
...
- Dialogue state and stack management
- Flow execution with policies and actions
- REST, Socket.IO, console, and inspection channels
- Extensible storage and business-data connectors
...
Install dependencies from `src/requirements-atguigu.txt`, configure service credentials, then start the CLI or API server from the `src` package.
